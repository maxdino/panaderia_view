        ...
        if($_SERVER["REQUEST_METHOD"]=="POST"){
          ...
          curl_setopt_array($curl, array(
            CURLOPT_URL => 'http://localhost/panaderia/index.php/categoria/'.$_POST['id'],
          ...
          curl_setopt_array($curl, array(
            CURLOPT_URL => 'http://localhost/panaderia/index.php/categoria/'.$_GET['id'],
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
                          ...
                          <div class="form-wrap">
                            <form method="POST" action="" enctype="multipart/form-data">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" required="true" name="categoria" id="categoria" autofocus="true" value="<?php echo $perfil['Detalles']['categoria']; ?>">
                              </div>  
                              <div class="form-group">
