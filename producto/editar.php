        ...
        if($_SERVER["REQUEST_METHOD"]=="POST"){
          ...
          curl_setopt_array($curl, array(
            CURLOPT_URL => 'http://polvazo.informaticapp.com/producto/'.$_POST["id"],
                        ...
                        <center class="m-t-30"> 
                          <div  class="avatar-upload">
                            ...
                            <div class="avatar-preview">
                              <?php
                              if ( $producto['Detalles']['imagen']=='') {
                                $imagen_producto ="librerias/assets/images/foto_perfil/defecto_imagen.png";
                              }else{
                                $imagen_producto ='librerias/imagen/'.$producto['Detalles']['imagen'];
                              }
                              ?>
                              <img  id="imagePreview" style="background-image: url(<?php echo $url_carpeta.$imagen_producto;  ?>);"/>
                            </div> 
                            <input type="hidden" name="imagen_valida" value="<?php echo $producto['Detalles']['imagen']; ?>">
                            ...
                            <div class="form-body">
                              ...
                              <div class="row p-t-0">
                                <div class="col-md-6">
                                  ...
                                  <input type="text" class="form-control solo_numero" maxlength="4" id="cantidad" name="cantidad" placeholder="cantidad" value="<?php echo $producto['Detalles']['cantidad']; ?>" required>
                                </div>
                                <div class="col-md-6">
                                  ...
                                  <?php if ($unidad_medida['Status']=='200') { ?>
                                    <select class="select2  " name="unidad_medida" id="unidad_medida" style="width: 100%; height:36px;">
                                      <option></option>
                                      <?php  foreach ($unidad_medida["Detalles"] as $key => $value) { if ($value['id_empresa']==$_COOKIE['id_empresa']) { if ($producto['Detalles']['id_unidad_medida']==$value['id_unidad_medida']) { 
                            ...
                            <div class="col-md-6">
                              ...
                              <?php if ($categoria['Status']=='200') { ?>
                                <select class="select2  " name="categoria" id="categoria" style="width: 100%; height:36px;">
                                  <option></option>
                                  <?php  foreach ($categoria["Detalles"] as $key => $value) { if ($value['id_empresa']==$_COOKIE['id_empresa']) { if ($producto['Detalles']['id_categoria']==$value['id_categoria']) {  
