        ...
        if($_SERVER["REQUEST_METHOD"]=="POST"){
          ...
          curl_setopt_array($curl, array(
            CURLOPT_URL => 'http://localhost/panaderia/index.php/empresa/'.$_POST['id'],
                    ...
                    <div class="card-body">
                      <center class="m-t-30"> 
                        <div  class="avatar-upload">
                          ...
                          <?php
                          if ( $empresa['Detalles']['imagen']=='') {
                            $imagen_producto ="librerias/assets/images/foto_perfil/defecto_imagen.png";
                          }else{
                            $imagen_producto ='librerias/imagen/'.$empresa['Detalles']['imagen'];
                          }
                          ?>
                          <div class="avatar-preview">
                            <img  id="imagePreview" style="background-image: url(<?php echo $url_carpeta.$imagen_producto;  ?>);"/>
                          </div> 
                          <input type="hidden" name="imagen_valida" value="<?php echo $empresa['Detalles']['imagen']; ?>">
                          ...
                          <div class="form-body">
                            ...
                            <div class="row  ">
                              ...
                              <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control solo_numero" maxlength="9" id="telefono" name="telefono" placeholder="telefono" value="<?php echo $empresa['Detalles']['telefono'] ?>" required>
                              </div>
                              <!--/span-->
                            </div>
                            <div class="row ">
