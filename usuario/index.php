        ...
        $data = array('titulo_descripcion' => 'Usuario', );
        if($_COOKIE['imagen']==""){
                      ...
                      <tbody id="cuerpo_tabla">
                       <?php if ($clientes['Status']=='200') { 
                        $c=1; foreach ($clientes["Detalles"] as $key => $value) { if ($_COOKIE['id_empresa']==$value['id_empresa']) { 
                          ...
                          <td><a href="eliminar.php?id=<?php echo $value['idEmpleado']; ?>" class="text-inverse" title="Eliminar" data-toggle="tooltip"><i class="mdi mdi-delete-empty txt-danger"></i></a> <a href="editar.php?id=<?php echo $value['idEmpleado']; ?>" class="text-inverse" title="Editar" data-toggle="tooltip"><i class="mdi mdi-table-edit txt-danger"></i></a></td>
                          <?php echo "</tr>";
                          $c++;
                      }  }  } ?>
                      </tbody>
