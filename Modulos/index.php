                            ...
                            <div class="table-responsive">
                              ...
                              <tbody id="cuerpo_tabla">
                                 <?php if ($listar_modulos['Status']=='200') { 
                                  $c=1; foreach ($listar_modulos["Detalles"] as $key => $value) {
                                    ...
                                    echo "<td><a href='javascript:void(0)' title='".$value["modulo_icono"]."'><i class='".$value["modulo_icono"]."' ></i></a></td>"; ?>
                                     <td><a href="eliminar.php?id=<?php echo $value['modulo_id']; ?>" class="text-inverse" title="Eliminar" data-toggle="tooltip"><i class="mdi mdi-delete-empty txt-danger"></i></a> <a href="editar.php?id=<?php echo $value['modulo_id']; ?>" class="text-inverse" title="Editar" data-toggle="tooltip"><i class="mdi mdi-table-edit txt-danger"></i></a></td>
                                   <?php echo "</tr>";
                                    $c++;
                                }  } ?>
                            </tbody>
