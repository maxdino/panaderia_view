        ...
        if($_SERVER["REQUEST_METHOD"]=="POST"){
          ...
          curl_setopt_array($curl, array(
            CURLOPT_URL => 'http://localhost/panaderia/index.php/modulos/'.$_POST["id"],
          ...
          curl_setopt_array($curl, array(
            CURLOPT_URL => 'http://localhost/panaderia/index.php/modulos/'.$id,
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
          ...
          curl_close($curl);
          $modulo_editar = json_decode($response, true);
        }
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form method="POST" action="">
                      <div class="form-row">
                        <input type="hidden"  name="id" id="id" value="<?php echo $modulo_editar['Detalles']['modulo_id']; ?>">
                        <div class="col-md-4 mb-3">
                          <label for="validationDefault01">DESCRIPCIÓN DEL MÓDULO</label>
                          <input type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Modulo" value="<?php echo $modulo_editar['Detalles']['modulo_nombre']; ?>" required>
                        </div>
                        <div class="col-md-4 mb-3">
                          <label for="validationDefault02">URL</label>
                          <input type="text" class="form-control" id="url" name="url" placeholder="URL" value="<?php echo $modulo_editar['Detalles']['modulo_url']; ?>" required>
                        </div>
                        <div class="col-md-4 mb-3">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="icono"  name="icono"  placeholder="" aria-describedby="inputGroupPrepend2" value="<?php echo $modulo_editar['Detalles']['modulo_icono']; ?>" required>
                          </div>
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="col-md-4 mb-3">
                          ...
                          <input type="text" class="form-control" id="orden" name="orden" placeholder="Orden" value="<?php echo $modulo_editar['Detalles']['modulo_orden']; ?>" required>
                        </div>
                        <div class="col-md-6 mb-3">
                          ...
                          <?php if ($listar_modulos['Status']=='200') { ?>
                            <select class="select2  " name="modulo" id="modulo" style="width: 100%; height:36px;">
                              <?php  foreach ($listar_modulos["Detalles"] as $key => $value) { if ($value['modulo_padre']==1) { if ($modulo_editar['Detalles']['modulo_padre']==$value["modulo_id"]) { 
                                echo "<option value='".$value["modulo_id"]."' selected>".$value["modulo_nombre"]."</option>";
                              }else{
