        ...
        $data = array('titulo_descripcion' => 'Compras', );
        if($_COOKIE['imagen']==""){
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-body" id="cuerpo_pagina"> 
                    <div class="row">
                     <div class="col-md-12">
                      <a href="agregar.php"><button class="btn  btn-success" >Agregar Categoria</button></a>
                    </div>
                  </div>
                  <div class="row">
                   <div class="col-md-12">
                     ...
                     <table class="table display product-overview mb-30" id="myTable">
                      <thead>
                        <tr>
                          ...
                          <th width="15%">Numero correlativo</th>
                      ...
                      <tbody id="cuerpo_tabla">
                       <?php if ($perfil['Status']=='200') { 
                        $c=1; foreach ($perfil["Detalles"] as $key => $value) { if ($_COOKIE['id_empresa']==$value['id_empresa']) {
                          ...
                          echo "<td>".$value["numero_correlativo"]."</td>";
                          echo "<td>"."S/ ".number_format($value["monto"], 2, '.', '')."</td>"; ?>
                          <td><a href="eliminar.php?id=<?php echo $value['id_compras']; ?>" class="text-inverse" title="Eliminar" data-toggle="tooltip"><i class="mdi mdi-delete-empty txt-danger"></i></a> <a href="editar.php?id=<?php echo $value['id_compras']; ?>" class="text-inverse" title="Editar" data-toggle="tooltip"><i class="mdi mdi-table-edit txt-danger"></i></a></td>
                          <?php echo "</tr>";
                          $c++;
                        } }  } ?>
                      </tbody>
