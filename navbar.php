                                    ...
                                    <ul id="sidebarnav">
                                        <li class="user-profile"> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><img class="foto_perfilupdate" src="<?php echo  $url_carpeta.'librerias/imagen/'.$_COOKIE['imagen']; ?>" alt="user" /><span class="hide-menu"><?php echo $_COOKIE['nombres']; ?> </span></a>
                                            <ul aria-expanded="false" class="collapse">
                                                <li><a href="../perfil_usuario/editar_perfil.php">Mi perfil </a></li>
                                        ...
                                        <?php $idhijo=0; foreach ($modulos['padre'] as $value) {  
                                          ...
                                          <?php  } } ?>
                                          <?php if ($_COOKIE['id_empresa']==5) {  ?>
                                           <li> <a  data-target="#cuerpo_0" class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class=" ti-briefcase"></i><span class="hide-menu">Empresa</span></a>
                                                    <ul id="cuerpo_0" aria-expanded="false" class="collapse">
                                                            <li><a   href="<?php echo $url_carpeta; ?>empresa/index.php">Empresa</a>
                                                            </li>
                                                        <li><a   href="<?php echo $url_carpeta; ?>modulos/index.php">Modulos</a>
                                                            </li>
                                                    </ul>
                                          </li>
                                        <?php }  ?>
