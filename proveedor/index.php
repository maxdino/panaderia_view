        ...
        $data = array('titulo_descripcion' => 'proveedor', );
        if($_COOKIE['imagen']==""){
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-body" id="cuerpo_pagina"> 
                    <div class="row">
                     <div class="col-md-12">
                      <a href="agregar.php"><button class="btn  btn-success" >Agregar Proveedor</button></a>
                    </div>
                  </div>
                  <div class="row">
                   <div class="col-md-12">
                     ...
                     <table class="table display product-overview mb-30" id="myTable">
                      ...
                      <tbody id="cuerpo_tabla">
                       <?php if ($proveedor['Status']=='200') { 
                        $c=1; foreach ($proveedor["Detalles"] as $key => $value) { if ($_COOKIE['id_empresa']==$value['id_empresa']) { 
                          echo "<tr>";
                          echo "<td>".$c."</td>";
                          echo "<td>".$value["nombres"]." ".$value["apellido1"]." ".$value["apellido2"]."</td>";
                          echo "<td>".$value["telefono"]."</td>";
                          echo "<td>".$value["direccion"]."</td>"; ?>
                          <td><a href="eliminar.php?id=<?php echo $value['id_proveedor']; ?>" class="text-inverse" title="Eliminar" data-toggle="tooltip"><i class="mdi mdi-delete-empty txt-danger"></i></a> <a href="editar.php?id=<?php echo $value['id_proveedor']; ?>" class="text-inverse" title="Editar" data-toggle="tooltip"><i class="mdi mdi-table-edit txt-danger"></i></a></td>
                          <?php echo "</tr>";
                          $c++;
                      }  }  } ?>
                      </tbody>
